...
public class HttpClient {
    ...
    /*public static void main(String[] args) throws IOException {
        ...
        params.put("accountSid","c30979411d1b416cbe754a1a20f3c973");
        params.put("templateid","164581550");
        int random = (int)((Math.random()* 1000000)+100000);
        params.put("param",random+"");
        params.put("to","15001083641");
        params.put("timestamp",TimeUtil.dateTostr(new Date(),"yyyyMMddHHmmss"));
        params.put("sig",Md5Util.getMd532(params.get("accountSid").toString()+"f3a94d0bc5074a12a6f6d76aacd2b8d2"+params.get("timestamp").toString()));
    ...
    public static String getMa(String canshu){

        String url= CommoBean.SMS_URL;
        HashMap<String, Object> params = new HashMap<String, Object>();
